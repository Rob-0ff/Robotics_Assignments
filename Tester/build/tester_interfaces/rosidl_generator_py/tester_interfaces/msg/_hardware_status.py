...
class Metaclass_HardwareStatus(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('tester_interfaces')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'tester_interfaces.msg.HardwareStatus')
            logger.debug(
...
class HardwareStatus(metaclass=Metaclass_HardwareStatus):
    ...
    def __init__(self, **kwargs):
        ...
        self.motors_ready = kwargs.get('motors_ready', bool())
    ...
    def __eq__(self, other):
        ...
        if self.temp != other.temp:
            return False
        if self.motors_ready != other.motors_ready:
            return False
    ...
    def temp(self, value):
        if self._check_fields:
            ...
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'temp' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._temp = value

    @builtins.property
    def motors_ready(self):
        """Message field 'motors_ready'."""
        return self._motors_ready

    @motors_ready.setter
    def motors_ready(self, value):
        if self._check_fields:
            assert \
                isinstance(value, bool), \
                "The 'motors_ready' field must be of type 'bool'"
        self._motors_ready = value
