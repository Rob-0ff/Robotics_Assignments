...
bool tester_interfaces__msg__hardware_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tester_interfaces.msg._hardware_status.HardwareStatus", full_classname_dest, 53) == 0);
  }
  tester_interfaces__msg__HardwareStatus * ros_message = _ros_message;
  {  // temp
  ...
  {  // motors_ready
    PyObject * field = PyObject_GetAttrString(_pymsg, "motors_ready");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->motors_ready = (Py_True == field);
    Py_DECREF(field);
  }
  {  // debug_message
...
PyObject * tester_interfaces__msg__hardware_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tester_interfaces.msg._hardware_status");
  ...
  {  // motors_ready
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->motors_ready ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "motors_ready", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
