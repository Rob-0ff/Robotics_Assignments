...
static const _HardwareStatus_type_support_symbol_names_t _HardwareStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tester_interfaces, msg, HardwareStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tester_interfaces, msg, HardwareStatus)),
  }
};
...
{
  return &::tester_interfaces::msg::rosidl_typesupport_cpp::HardwareStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tester_interfaces, msg, HardwareStatus)() {
  return get_message_type_support_handle<tester_interfaces::msg::HardwareStatus>();
}
