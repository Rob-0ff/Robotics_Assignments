...
{
  new (message_memory) tester_interfaces::msg::HardwareStatus(_init);
}

void HardwareStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tester_interfaces::msg::HardwareStatus *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember HardwareStatus_message_member_array[3] = {
  {
    ...
    offsetof(tester_interfaces::msg::HardwareStatus, temp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tester_interfaces::msg::HardwareStatus, motors_ready),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tester_interfaces::msg::HardwareStatus, debug_message),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers HardwareStatus_message_members = {
  "tester_interfaces::msg",  // message namespace
  "HardwareStatus",  // message name
  3,  // number of fields
  sizeof(tester_interfaces::msg::HardwareStatus),
...
{
  return &::tester_interfaces::msg::rosidl_typesupport_introspection_cpp::HardwareStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tester_interfaces, msg, HardwareStatus)() {
  return &::tester_interfaces::msg::rosidl_typesupport_introspection_cpp::HardwareStatus_message_type_support_handle;
}
