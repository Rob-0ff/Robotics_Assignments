...
#ifndef LED_INTERFACES__MSG__DETAIL__LED_PANEL_STATE__FUNCTIONS_H_
#define LED_INTERFACES__MSG__DETAIL__LED_PANEL_STATE__FUNCTIONS_H_
 ...
 * )) before or use
 * led_interfaces__msg__LedPanelState__create()
 ...
 * calls
 * led_interfaces__msg__LedPanelState__init().
...
/**
 * It calls
 * led_interfaces__msg__LedPanelState__fini()
 ...
 * led_interfaces__msg__LedPanelState__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * led_interfaces__msg__LedPanelState__Sequence__fini()
 * on the array,
...
#endif  // LED_INTERFACES__MSG__DETAIL__LED_PANEL_STATE__FUNCTIONS_H_
