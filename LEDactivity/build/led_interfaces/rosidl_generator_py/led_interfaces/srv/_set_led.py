...
class SetLED_Event(metaclass=Metaclass_SetLED_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<led_interfaces/SetLED_Request, 1>',
        'response': 'sequence<led_interfaces/SetLED_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['led_interfaces', 'srv'], 'SetLED_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['led_interfaces', 'srv'], 'SetLED_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from led_interfaces.srv import SetLED_Request
    ...
    def response(self, value):
        if self._check_fields:
            from led_interfaces.srv import SetLED_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_SetLED(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from led_interfaces.srv import _set_led
...
class SetLED(metaclass=Metaclass_SetLED):
    from led_interfaces.srv._set_led import SetLED_Request as Request
    from led_interfaces.srv._set_led import SetLED_Response as Response
    from led_interfaces.srv._set_led import SetLED_Event as Event
