...
static const _LedPanelState_type_support_symbol_names_t _LedPanelState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, led_interfaces, msg, LedPanelState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, led_interfaces, msg, LedPanelState)),
  }
};
...
{
  return &::led_interfaces::msg::rosidl_typesupport_cpp::LedPanelState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, led_interfaces, msg, LedPanelState)() {
  return get_message_type_support_handle<led_interfaces::msg::LedPanelState>();
}
